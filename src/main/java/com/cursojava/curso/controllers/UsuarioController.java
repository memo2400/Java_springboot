...
public class UsuarioController {
    ...
    /*
     * hace que la clase usuarioDaoImplement 
     * cree un objeto y la guarde en usuarioDao
     * si usamos mucho el @autowired, el objeto
     * estaria compartido, en memoria
    ...
    public List <Usuario> obtenerUsuarios () {
        ...
        // Con esta linea hacemos la consulta a BD
        return usuarioDao.obtenerUsuario();
        
        // Toda esa parte se utilizo para hacer pruebas previo a la BD
